...
function App() {
  ...
  return (
    <div className="bg-gray-900 text-white">
      ...
      <section
        id="why-us"
        className="why-us-section py-20 bg-gradient-to-b from-gray-800 to-gray-900"
      >
        <WhyUs />
      </section>
      ...
      <section
        id="trainers"
        className="trainers-section relative py-24 bg-gradient-to-b from-gray-900 to-gray-800"
      >
        <div className="container mx-auto px-4">
          <h2 className="absolute top-10 left-0 right-0 text-center text-4xl md:text-5xl font-bold uppercase tracking-wide">
