    ...
    <div className="min-h-screen bg-gray-800">
      ...
      <section className="container mx-auto p-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
          ...
          <h2 className='text-2xl md:text-3xl font-bold text-white'>Meal Library</h2>
                ...
                {selectedMeal && (
                  <div className="mb-4 p-4 bg-gray-100 rounded">
                    ...
                    <p className="text-sm text-gray-600">
                      {selectedMeal.calories} calories • {selectedMeal.protein}g protein
                    </p>
                  </div>
                )}
            ...
            filteredMeals.map((meal) => (
              meal && meal.meal_id ? (
                ...
                >
                  ...
                  <h3 className="text-xl font-bold mb-2 capitalize">{meal.m_name || 'Unnamed Meal'}</h3>
                  <p className="text-gray-600 mb-1"><span className="font-medium">Type:</span> <span className="capitalize">{meal.type || 'other'}</span></p>
                  <p className="text-gray-600 mb-1"><span className="font-medium">Prep Time:</span> {meal.preparationTime || 0} mins</p>
                  <p className="text-gray-600 mb-1"><span className="font-medium">Serving:</span> {meal.servingSize || 'N/A'}</p>
                  ...
                  <div className="my-3 p-2 bg-gray-200 rounded h-9 overflow-hidden hover:h-45 transition-all">
                    ...
                    <p className="text-gray-600">Calories: {meal.calories || 0}</p>
                    <p className="text-gray-600">Protein: {meal.protein || 0}g</p>
                  ...
                  <div className="flex flex-wrap gap-2 mb-3">
                    {meal.isVegetarian && <span className="bg-green-100 text-green-800 text-xs px-2 py-1 rounded">Vegetarian</span>}
                    {meal.isVegan && <span className="bg-green-100 text-green-800 text-xs px-2 py-1 rounded">Vegan</span>}
                    {meal.isGlutenFree && <span className="bg-green-100 text-green-800 text-xs px-2 py-1 rounded">Gluten Free</span>}
                  </div>
